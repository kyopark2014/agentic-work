...
# ---------------------------------------------------------------------------
# Documents (projects + drawings) — per-user under session_storage/{user}/documents
# ---------------------------------------------------------------------------
...
def _ensure_documents_on_path() -> str:
    """Put ``agentic-work/documents`` on ``sys.path`` so ``doc_list`` is importable."""
...
# ---------------------------------------------------------------------------
# Documents S3 uploads + UI enrichment (projects / drawings)
# ---------------------------------------------------------------------------
